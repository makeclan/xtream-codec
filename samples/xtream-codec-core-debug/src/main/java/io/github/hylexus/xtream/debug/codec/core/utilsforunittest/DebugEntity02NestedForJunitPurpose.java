 ...
 */
public interface DebugEntity02NestedForJunitPurpose {

    /**
     * 这个接口仅仅是为了 Junit 中赋值、取值方便（没有其他任何目的）
     */
    interface DebugEntity02HeaderForJunitPurpose {
        int getMsgId();
     ...
     * 这个接口仅仅是为了 Junit 中赋值、取值方便（没有其他任何目的）
     */
    interface DebugEntity02BodyForJunitPurpose {
        long getAlarmFlag();
     ...
     * 这个接口仅仅是为了 Junit 中赋值、取值方便（没有其他任何目的）
     */
    interface DebugEntity02ExtraItemForJunitPurpose {
        short getId();
