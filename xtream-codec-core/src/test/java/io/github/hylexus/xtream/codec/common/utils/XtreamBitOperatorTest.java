...
import static io.github.hylexus.xtream.codec.common.utils.XtreamBitOperator.*;
...
class XtreamBitOperatorTest {
    ...
    @Test
    void testRange() {
        final XtreamBitOperator operator = mutable(0).set(63);
        ...
        final XtreamBitOperator operator1 = immutable(0);
        // 全 1
    ...
    @Test
    void test() {
        assertEquals("10001010", XtreamBitOperator.immutable(0).set(1).set(7).set(3).binaryString());
        assertEquals("10001010", XtreamBitOperator.immutable(0).set(1).set(7).set(3).binaryString(8));
        assertEquals("0000000010001010", XtreamBitOperator.immutable(0).set(1).set(7).set(3).binaryString(16));

        assertEquals(0b11010110L, XtreamBitOperator.immutable(0b11111111).reset(0).reset(3).reset(5).longValue());

        assertEquals("8a", XtreamBitOperator.immutable(0).set(1).set(7).set(3).hexString());
        assertEquals("0000008a", XtreamBitOperator.immutable(0).set(1).set(7).set(3).hexString(8));
        assertEquals(0b11010110, XtreamBitOperator.immutable(0b11111111).reset(0).reset(3).reset(5).intValue());
    }

    @Test
    void testImmutable() {
        final XtreamBitOperator instance1 = XtreamBitOperator.immutable(1);
        final XtreamBitOperator instance2 = instance1.map(it -> it * 2);
        // instance1 != instance2
    ...
    @Test
    void testMutable() {
        final XtreamBitOperator instance1 = mutable(1);
        final XtreamBitOperator instance2 = instance1.map(it -> it * 2);
        // instance1 == instance2
