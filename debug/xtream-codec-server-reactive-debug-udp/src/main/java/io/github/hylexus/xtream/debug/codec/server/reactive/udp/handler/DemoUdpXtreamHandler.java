...
public class DemoUdpXtreamHandler implements SimpleXtreamRequestHandler {

    private static final Logger log = LoggerFactory.getLogger(DemoUdpXtreamHandler.class);

    public DemoUdpXtreamHandler() {
    }
