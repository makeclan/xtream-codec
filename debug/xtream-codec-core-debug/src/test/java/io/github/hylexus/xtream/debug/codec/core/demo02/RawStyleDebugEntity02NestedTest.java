...
class RawStyleDebugEntity02NestedTest extends BaseEntityCodecTest {
    ...
    @Test
    void test() {
        final RawStyleDebugEntity02Nested originalEntity = this.createEntity();
        final String hexString = this.encodeAsHexString(originalEntity);
        final RawStyleDebugEntity02Nested entity = this.doDecode(RawStyleDebugEntity02Nested.class, hexString);
        ...
        for (int i = 0; i < originalEntity.getBody().getExtraItems().size(); i++) {
            final RawStyleDebugEntity02Nested.ExtraItem originalItem = originalEntity.getBody().getExtraItems().get(i);
            final RawStyleDebugEntity02Nested.ExtraItem item = entity.getBody().getExtraItems().get(i);
    ...
    RawStyleDebugEntity02Nested createEntity() {
        final RawStyleDebugEntity02Nested entity = new RawStyleDebugEntity02Nested();
        final RawStyleDebugEntity02Nested.Header header = new RawStyleDebugEntity02Nested.Header();
        final RawStyleDebugEntity02Nested.Body body = new RawStyleDebugEntity02Nested.Body();
        entity.setHeader(header);
        entity.setBody(body);
        int bodyLength = this.initBody(body);
        body.setExtraItems(List.of(
                new RawStyleDebugEntity02Nested.ExtraItem((short) 0x01, (short) 4, ByteArrayContainer.ofDword(6666).asBytes()),
                new RawStyleDebugEntity02Nested.ExtraItem((short) 0x02, (short) 2, ByteArrayContainer.ofWord(88).asBytes()),
                new RawStyleDebugEntity02Nested.ExtraItem((short) 0x03, (short) 2, ByteArrayContainer.ofWord(89).asBytes())
        ));
    ...
    int initBody(RawStyleDebugEntity02Nested.Body body) {
        int msgBodyLength = 0;
    ...
    void initHeader(RawStyleDebugEntity02Nested.Header header) {
