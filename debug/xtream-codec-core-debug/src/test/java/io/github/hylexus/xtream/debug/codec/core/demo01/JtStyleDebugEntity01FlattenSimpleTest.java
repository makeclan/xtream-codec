...
class JtStyleDebugEntity01FlattenSimpleTest extends BaseEntityCodecTest {
    ...
    @Test
    void test() {
        final JtStyleDebugEntity01FlattenSimple originalEntity = this.createEntity();
        final String hexString = this.encodeAsHexString(originalEntity);
        final JtStyleDebugEntity01FlattenSimple decodedEntity = this.doDecode(JtStyleDebugEntity01FlattenSimple.class, hexString);
