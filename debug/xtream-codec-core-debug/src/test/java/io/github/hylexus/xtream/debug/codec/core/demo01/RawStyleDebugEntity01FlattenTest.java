...
class RawStyleDebugEntity01FlattenTest extends BaseEntityCodecTest {
    ...
    @Test
    void test() {
        final RawStyleDebugEntity01Flatten originalEntity = this.createEntity();
        final String hexString = this.encodeAsHexString(originalEntity);

        final RawStyleDebugEntity01Flatten decodedEntity = this.doDecode(RawStyleDebugEntity01Flatten.class, hexString);
    ...
    RawStyleDebugEntity01Flatten createEntity() {
        final RawStyleDebugEntity01Flatten entity = new RawStyleDebugEntity01Flatten();
        // region header
