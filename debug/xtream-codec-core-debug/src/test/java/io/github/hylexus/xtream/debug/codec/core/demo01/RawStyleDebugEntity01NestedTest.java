...
class RawStyleDebugEntity01NestedTest extends BaseEntityCodecTest {
    ...
    @Test
    void test() {
        final RawStyleDebugEntity01Nested originalEntity = this.createEntity();
        final String hexString = this.encodeAsHexString(originalEntity);

        final RawStyleDebugEntity01Nested entity = this.doDecode(RawStyleDebugEntity01Nested.class, hexString);
    ...
    RawStyleDebugEntity01Nested createEntity() {
        final RawStyleDebugEntity01Nested entity = new RawStyleDebugEntity01Nested();
        final RawStyleDebugEntity01Nested.Body body = new RawStyleDebugEntity01Nested.Body();
        final RawStyleDebugEntity01Nested.Header header = new RawStyleDebugEntity01Nested.Header();
