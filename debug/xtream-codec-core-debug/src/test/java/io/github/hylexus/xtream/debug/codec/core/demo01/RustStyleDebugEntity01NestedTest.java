...
class RustStyleDebugEntity01NestedTest extends BaseEntityCodecTest {
    ...
    @Test
    void test() {
        final RustStyleDebugEntity01Nested originalEntity = this.createEntity();
        final String hexString = this.encodeAsHexString(originalEntity);

        final RustStyleDebugEntity01Nested entity = this.doDecode(RustStyleDebugEntity01Nested.class, hexString);
    ...
    RustStyleDebugEntity01Nested createEntity() {
        final RustStyleDebugEntity01Nested entity = new RustStyleDebugEntity01Nested();
        final RustStyleDebugEntity01Nested.Body body = new RustStyleDebugEntity01Nested.Body();
        final RustStyleDebugEntity01Nested.Header header = new RustStyleDebugEntity01Nested.Header();
