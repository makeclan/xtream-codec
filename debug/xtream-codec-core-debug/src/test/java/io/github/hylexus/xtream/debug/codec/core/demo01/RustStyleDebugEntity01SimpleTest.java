...
class RustStyleDebugEntity01SimpleTest extends BaseEntityCodecTest {
    ...
    @Test
    void test() {
        final RustStyleDebugEntity01FlattenSimple originalEntity = this.createEntity();
        final String hexString = this.encodeAsHexString(originalEntity);
        final RustStyleDebugEntity01FlattenSimple decodedEntity = this.doDecode(RustStyleDebugEntity01FlattenSimple.class, hexString);
    ...
    RustStyleDebugEntity01FlattenSimple createEntity() {
        final RustStyleDebugEntity01FlattenSimple entity = new RustStyleDebugEntity01FlattenSimple();
        // region header
