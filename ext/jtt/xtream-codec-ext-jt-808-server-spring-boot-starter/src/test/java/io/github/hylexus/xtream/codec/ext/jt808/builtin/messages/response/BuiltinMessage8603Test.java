...
class BuiltinMessage8603Test extends BaseCodecTest {

    @Test
    void testEncode() {
        final BuiltinMessage8603 entity = new BuiltinMessage8603();
        ...
        assertEquals("7e8603400d01000000000139123443290000030000006f000000de0000014d437e", hex);
    }

    @Test
    void testDecode() {
        final String hex = "8603400d01000000000139123443290000030000006f000000de0000014d43";
        final BuiltinMessage8603 entity = decodeAsEntity(BuiltinMessage8603.class, hex);
