...
class BuiltinMessage8607Test extends BaseCodecTest {

    @Test
    void testEncode() {
        final BuiltinMessage8607 entity = new BuiltinMessage8607();
        ...
        assertEquals("7e8607400d01000000000139123443290000030000006f000000de0000014d477e", hex);
    }

    @Test
    void testDecode() {
        final String hex = "8607400d01000000000139123443290000030000006f000000de0000014d47";
        final BuiltinMessage8607 entity = decodeAsEntity(BuiltinMessage8607.class, hex);
