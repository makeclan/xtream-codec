 ...
 *
 * # .mp3 --> G711-MuLaw
 * ffmpeg -i lchs-slice.mp3 -ar 8000 -ac 1 -f mulaw -acodec pcm_mulaw lchs-slice.g711u-8k
 * ffplay -f mulaw -ar 8000 -i lchs-slice.g711u-8k
 * }</pre>
 */
class G711MuLawJt1078AudioCodecTest extends AbstractAudioVideoCodecTest {

    /// ```sh
    /// ffplay -f s16le -ar 8000 -i lchs-slice.g711u-8k.pcm
    ///```
    @Test
    void test() throws Exception {
        final String inputFile = "mock-data/g711/lchs-slice.g711u-8k";
        final String outputFile = "mock-data/output/g711/lchs-slice.g711u-8k.pcm";
        deleteFileIfExists(outputFile);

        final G711MuLawJt1078AudioCodec codec = new G711MuLawJt1078AudioCodec();
        try (
