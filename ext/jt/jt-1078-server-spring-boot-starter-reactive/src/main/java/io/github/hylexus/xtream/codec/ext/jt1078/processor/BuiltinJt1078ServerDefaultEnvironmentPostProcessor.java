 ...
 * @author hylexus
 */
public class BuiltinJt1078ServerDefaultEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {

    private static final String DEFAULT_JT_808_SERVER_CONFIG_PROPERTY_SOURCE_NAME = "default-xtream-jt1078-server-config";
