...
@ConditionalOnJt808Server(serverType = ConditionalOnJt808Server.ServerType.ANY, protocolType = ConditionalOnJt808Server.ProtocolType.UDP)
public class BuiltinJt808ServerUdpCommonConfiguration {
