 ...
 */
public class Jt808VersionHandlerAdapter implements R2dbcTypeHandlerAdapter<Jt808Version> {

    @Override
    public Class<Jt808Version> adaptClazz() {
        return Jt808Version.class;
    }

    @Override
    public void setParameter(Statement statement,
                             ParameterHandlerContext parameterHandlerContext,
                             Jt808Version parameter) {
        statement.bind(parameterHandlerContext.getIndex(), parameter.getValue());
    }

    @Override
    public Jt808Version getResult(Readable readable, ReadableMetadata readableMetadata, String columnName) {
        Integer result = readable.get(columnName, Integer.class);
        return result == null ? null : Jt808Version.fromValue(result);
    }

    @Override
    public Jt808Version getResult(Readable readable, ReadableMetadata readableMetadata, int columnIndex) {
