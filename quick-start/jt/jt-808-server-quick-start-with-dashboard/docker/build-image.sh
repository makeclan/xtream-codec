...
SUBPROJECT_ROOT_DIR="${XTREAM_PROJECT_ROOT_DIR}/quick-start/jt/jt-808-server-quick-start-with-dashboard"
...
:quick-start:jt:jt-808-server-quick-start-with-dashboard:build \

cd ${SUBPROJECT_ROOT_DIR}

#docker build -t jt-808-server-quick-start-with-dashboard:latest \
...
-t registry.cn-hangzhou.aliyuncs.com/xtream-codec/jt-808-server-quick-start-with-dashboard:latest \
-t registry.cn-hangzhou.aliyuncs.com/xtream-codec/jt-808-server-quick-start-with-dashboard:${XTREAM_PROJECT_VERSION} \
-f ${SUBPROJECT_ROOT_DIR}/docker/Dockerfile \
${SUBPROJECT_ROOT_DIR} \
--push
