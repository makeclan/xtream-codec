 ...
 * @author hylexus
 */
public class XtreamRequestArgumentResolver implements XtreamHandlerMethodArgumentResolver {

    @Override
    public boolean supportsParameter(XtreamMethodParameter parameter) {
        return XtreamRequest.class.isAssignableFrom(parameter.getParameterType());
    }
