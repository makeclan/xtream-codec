 ...
 * @author hylexus
 */
public class UdpXtreamHandlerAdapterBuilder extends AbstractXtreamHandlerAdapterBuilder<UdpXtreamHandlerAdapterBuilder, UdpXtreamNettyHandlerAdapter> {
    public UdpXtreamHandlerAdapterBuilder() {
    }
